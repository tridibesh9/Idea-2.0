...
export const addMessage = (id, data) => api.post(`/complaints/${id}/messages`, data);
export const getSimilar = (id) => api.get(`/complaints/${id}/similar`);
export const generateResponse = (id, data) => api.post(`/complaints/${id}/generate-response`, data);

// ── Analytics ──
export const getAnalyticsSummary = () => api.get('/analytics/summary');
export const getTrends = (params) => api.get('/analytics/trends', { params });
export const getRootCause = (params) => api.get('/analytics/root-cause', { params });
